...
def get_all():
    ...
    print('{:^10} | {:^9} | {:^9} | {:^9} | {:^9} | {:^9} | {:^9} | {:^9} | {:^9} | {:^10}'.format('', *columns[2:])) # noqa E501
    print('-' * 140)
    fmt = '{:10s} | {:11d} | {:11d} | {:11d} | {:11d} | {:12d} | {:12d} | {:12d} | {:12d} | {:10s}' # noqa E501
    for i in query:
        print(fmt.format(
            i.company,
            i.qliq_1_fact,
...
def get_total(start_date, end_date):
    query = db_session.query(
        ...
        .filter(and_(
            Data.created_at >= start_date, Data.created_at <= end_date
        )
    ).all()
    columns = get_fields_name(Data)
    columns = [f'total_{i}' for i in columns[2:-1]]
    print('{:^10} | {:^9} | {:^9} | {:^9} | {:^9} | {:^9} | {:^9} | {:^9} | {:^9}'.format('', *columns)) # noqa E501
    print('-' * 180)
    fmt = '{:10s} | {:17d} | {:17d} | {:17d} | {:17d} | {:18d} | {:18d} | {:18d} | {:18d}' # noqa E501
    for row in query:
